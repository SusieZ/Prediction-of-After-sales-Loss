...
import pandas as pd
import os,sys
sys.path.append("code-path/After_Sales_FC")
...
# feature processing: 
Processing= FP.feature_preprocessing(df_mainten,mlist.charCol,mlist.floatCol,"Featuretablelpath/","Mat_Raw_0518.csv")   
Raw_data=Processing.feature_engineering()

# got model raw data
featurefile="Featuretablelpath/Mat_Raw_0518.csv"
...
R_model,R_scores=Me.Model_all(dX_train,dX_test,dy_train,dy_test,'modelpath/k-models/my_model-0517.h5')
y_pred,t_scores=Me.Model_Useing('modelpath/k-models/my_model-0517.h5',dX_test,dy_test)
